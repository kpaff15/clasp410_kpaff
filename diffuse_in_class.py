...
def solve_heat(xstop=1, tstop=0.2, dx=0.2, dt=0.02, c2=1, lowerbound=0, upperbound=0):
    '''
    A fucntion for solving the heat equation.
    Apply Neumann boundary conditions such that dU/dx = 0.

    Parameters
    ---------
    Fill this out don't forget!
    c2: float
...
def plot_heatsolve(t, x, U, title=None, **kwargs):
    ...
    fig, ax : Matplotlib figure and axes objects
        The figure and axes fo the plot.
    ...
    contour = ax.pcolor(t,x,U,**kwargs) # pcolor means polygon color
